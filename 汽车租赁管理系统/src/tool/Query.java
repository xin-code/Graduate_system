...
public class Query {
    public static void updateOrderState(String ordernumber){
        ...
        try{
            ...
            String sql="update orders set orderStatus= '已租赁' where orderNumber= "+"'"+ordernumber+"'";
    ...
    public static OrderView getFullOrderViews(String roomid) {
        ...
        try {
            ...
            preparedStatement = connection.prepareStatement("select * from orderviews where roomNumber='"+roomid+"' and orderStatus='已租赁'");
            //获取结果数据集
            resultSet = preparedStatement.executeQuery();
...
//                        String remarks) {
    ...
    public static Order getOrder(String roomid){
        ...
        try {
            connection =  DataBase.getConnection();
            String sql ="select * from orders where roomNumber='"+roomid+"' and orderStatus='已租赁'" ;
            preparedStatement = connection.prepareStatement(sql);
            resultSet = preparedStatement.executeQuery();
            if(resultSet.next()){
