...
<%
    ...
    for (int i = 0; i < allOrders.size(); i++) {
        if (allOrders.get(i).getOrderStatus().equals("已租赁")) {
            checkInOrderNumber++;
        } else if (allOrders.get(i).getOrderStatus().equals("已退车")) {
            checkOutOrderNumber++;
        ...
        <div class="ui column grid">
            ...
            <div class="seven wide column">
                ...
                <div class="nine wide column">
                    <div id="income" style="width: 188%;height:42%; display:block "></div>
                    <script>
