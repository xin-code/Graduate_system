...
<head>
    ...
    <%
        ...
        ArrayList<CarTypeAndPrice>list = Query.searchCar(size1,size2,size3) ;
//        for (CarTypeAndPrice rp : list){
//            System.out.println(rp.getCarType());
//        }


        String rs1[] = {"单人","双人","任意"}  ;
        String rs2[] = {"标准","商务","跑车","任意"}  ;
    ...
    <script>
        function fun() {
           ...
           //如果这样定义var v;变量v中会默认被赋个null值
            ...
            window.location.href='/carManagement/searchCar.jsp?'+v
        }
    </script>
                        ...
                        <div class="content">
                            ...
                            <div class="extra">
                                <div class="ui right floated  button">
                                    <a href="/carOrder.jsp?op=2&cartype=<%=rtp.getCarType()%>">预定</a>
