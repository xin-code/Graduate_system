...
<%
    ...
    Order order =null ;
    if(op==2){
        System.out.println("车辆编号:"+map.get("roomid")[0]);
        ...
        <div class="ui column grid">
            ...
            <div class="eleven wide  column" >
                ...
                <form class="ui form" onsubmit="return fun(this)">
                    ...
                    <div class="four wide column">
                        ...
                        <div class="five wide field">
                            ...
                            <%--<input type="text" name="roomid" placeholder="车牌号">--%>
                        </div>
                    </div>
                    <br/>
                ...
                <div class="ui right button" >
                    ...
                    <a href="/roomCheckOut.jsp?op=3&orderNumber=<%=order.getOrderNumber()%>">确认退车</a>
                </div>
                <%}else if (op == 3) {
