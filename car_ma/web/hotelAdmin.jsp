...
<div class="ui inverted menu">
    ...
    <div class="ui simple dropdown item">
        ...
        <div class="menu">
            <a class="item" href="/roomOrder.jsp?op=1"><i class="arrow right icon"></i>租车</a>
            <a class="item" href="/roomRenew.jsp?op=1"><i class="spinner icon"></i>续费</a>
            <a class="item" href="/roomCheckOut.jsp?op=1"><i class="arrow left icon"></i>退车</a>
        </div>
    </div>
    <div class="ui simple dropdown item">
        ...
        <i class="dropdown icon"></i>
        <div class="menu">
            <a class="item" href="/RoomManage?op=1"><i class="search icon"></i>车辆</a>
            <a class="item" href="/RoomManage?op=2"><i class="plus icon"></i>增加车辆</a>
            <a class="item" href="/roomManagement/roomPriceManage.jsp?op=2"><i class="edit icon"></i>车辆价格管理 </a>
        </div>
    </div>
    <div class="ui simple dropdown item">
        ...
        <i class="dropdown icon"></i>
        <div class="menu">
            <a class="item" href="/OrderManage?op=2"><i class="file icon"></i>用车订单</a>
    ...
    <div class="right menu">
        <div class="ui simple dropdown item">
            <i class="user icon"></i>
            <%="租赁管理员: " + session.getAttribute("hoteladmin")%>  <%-- 后期换成session("name")  --%>
            <i class="dropdown icon"></i>
            <div class="menu">
